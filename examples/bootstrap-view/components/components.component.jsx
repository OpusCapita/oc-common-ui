...
function Components() {
  return (
    <Card expanded id="components">
      <CardHeader>Components</CardHeader>
      <CardContent>
        <p>Before implementing a new component go through following checklist:</p>
        <ol>
          <li>Is there an existing common component.
            If comparable component is found then it could be extended?</li>
        ...
        <p>If none of the above criteria is met then implement a new component.
          Add the component to the common component library
          if it can be used elsewhere as well.</p>
      </CardContent>
    </Card>
  );
}

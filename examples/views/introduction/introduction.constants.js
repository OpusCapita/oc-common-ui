  ...
  topics: [
    ...
    },
    {
      ...
      topics: [
        {
          heading: '',
          content: 'This document explains the high level principles for the user interface decisions, ' +
            'but also acts as a practical guide when extending the services and building new features.',
        },
      ],
    },
    {
      ...
      topics: [
        ...
        {
          heading: 'Existing',
          content: 'Apply 3rd party fully and parts from  new wherever possible with reasonable effort.',
        },
      ],
    },
  ],
